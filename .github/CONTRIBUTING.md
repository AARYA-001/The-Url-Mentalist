# Contributing to The Url Mentalist
...
- `server/` â€“ Backend (Golang)
- `web/website` â€“ Frontend (Svelte)
- `docker/` â€“ Dockerfiles & Compose configs
...
### Dev environment (Docker â€” recommended)
...
Your contributions make this project better â€” whether it's code, feedback, or documentation.
