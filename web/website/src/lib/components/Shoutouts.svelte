<script lang="ts">
  ...
  const items: Item[] = [
    ...
    },
    {
      ...
      date: "May 21, 2026",
      text: "The Url Mentalist. Open-source phishing detection engine — get a trust score, a fully explainable verdict, and a shareable security report with live page preview, all in real time.",
    ...
    },
    {
      ...
      handle: "@NeoteoCom",
      date: "Jan 16, 2026",
      text: "The Url Mentalist, an open-source phishing detection engine with a web UI and browser extension. Easy to integrate to protect users and reduce fraud.",
    ...
    },
    {
      ...
      handle: "@so_sthbryan",
      date: "May 16, 2026",
      text: "Explainable phishing detection that scans URLs in real time. The Url Mentalist catches phishing sites before you interact with them.",
    ...
    },
    {
      ...
      handle: "@ozogretmen",
      date: "May 14, 2026",
      text: "Unsure where a link you click online will take you? The Url Mentalist is a powerful phishing detection engine that scans, scores, and transparently explains why a link is safe or not in real time.",
