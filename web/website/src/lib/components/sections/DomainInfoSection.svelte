  ...
  >
    ...
    >
      ...
      >
        ...
        <span class="font-medium text-[#424242] dark:text-white">{formatDate(domainInfo.created)}</span>
      </div>
      ...
      >
        ...
        <span class="font-medium text-[#424242] dark:text-white">{formatDate(domainInfo.updated)}</span>
      </div>
      ...
      >
        ...
        <span class="font-medium text-[#424242] dark:text-white">{formatDate(domainInfo.expiry)}</span>
      </div>
