      ...
      {#if sslInfo}
        ...
        {#if sslInfo.HasTLS}
          ...
          >
            ...
            <span class="font-medium text-[#424242] dark:text-white">{formatDate(sslInfo.NotBefore)}</span>
          </div>
          ...
          >
            ...
            <span class="font-medium text-[#424242] dark:text-white">{formatDate(sslInfo.NotAfter)}</span>
          </div>
