<svelte:head>
  <title>How It Works — The Url Mentalist</title>
  <meta
    name="description"
    content="How The Url Mentalist scans links, what it checks, and what each result means."
  />
  <link rel="canonical" href="Live_deployment_link/how-it-works" />
</svelte:head>
...
<div class="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
  <div class="max-w-3xl mx-auto px-6 py-16">
    ...
    <section class="mb-14">
      ...
      <ol class="space-y-5">
        {#each [{ n: "1", title: "Paste any link", desc: "Drop a URL into the input box. Full link, shortened link, or just a domain like example.com. The Url Mentalist handles the formatting." }, { n: "2", title: "Click Scan", desc: "The scan runs live. It takes a few seconds because The Url Mentalist fetches the page in real time rather than looking it up in a cached index." }, { n: "3", title: "Read the result", desc: "You'll get a trust score from 0 to 100, a verdict, and a breakdown of every check that ran." }] as item}
          <li class="flex gap-4">
            <span
    ...
    <section class="mb-14">
      ...
      <div class="mb-8">
        ...
        <p class="text-base text-gray-600 dark:text-gray-400">
          The Url Mentalist takes a live screenshot of the page. It's one of the fastest ways to
          spot a phishing site. If the page looks like your bank's login screen but the domain has
          nothing to do with your bank, that's something no automated check can fully catch.
        </p>
      </div>
    ...
    <section class="mb-14">
      ...
      <div class="mb-4">
        <img
          src="/pipeline.png"
          alt="The Url Mentalist analyzer pipeline showing 18 checks across 7 signal categories"
    ...
    <section class="mb-14">
      ...
      <div class="space-y-3 text-base text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <p>Use The Url Mentalist as one layer of defense, not the only one.</p>
      </div>
    </section>
