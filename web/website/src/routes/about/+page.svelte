<svelte:head>
  <title>About — The Url Mentalist</title>
  <meta
    name="description"
    content="The Url Mentalist is an open-source phishing detection engine built to make the web a little safer. Free, transparent, and fully explainable."
  />
  <link rel="canonical" href="Live_deployment_link/about" />
</svelte:head>
  ...
  <div class="max-w-3xl mx-auto px-6 py-16">
    ...
    <section class="mb-14">
      ...
      <div class="space-y-4 text-gray-600 dark:text-gray-400 text-base leading-relaxed">
        ...
        <p>
          The Url Mentalist is that middle ground. Paste a link, get a trust score, a verdict, and a
          full breakdown in seconds. No guesswork, no signup, nothing hidden.
        </p>
        <p>
    ...
    <section class="mb-14">
      ...
      <p class="text-base text-gray-600 dark:text-gray-400 mb-3 leading-relaxed">
        The Url Mentalist is fully open source. A lot of projects call themselves open source but
        only publish the frontend while keeping the actual engine private. Here, everything is
        publicly available. The detection engine, scoring logic, API, and frontend. Nothing hidden.
      </p>
    ...
    <section>
      ...
      <p class="text-base text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <a
          ...
          >team@the-url-mentalist.example</a
        >.
      </p>
    </section>
  </div>
