...
<svelte:head>
  {#if shareDomain}
    ...
    {@const desc = ogVerdict
      ? `${ogVerdict} — The Url Mentalist scanned ${shareDomain}. See the full breakdown.`
      : `Sketchy link? The Url Mentalist scanned ${shareDomain} — check if it's actually safe to click.`}
    {@const ogImage = `Live_deployment_link/og?domain=${encodeURIComponent(shareDomain)}${ogVerdict ? `&v=${encodeURIComponent(ogVerdict)}` : ""}${ogScore !== undefined ? `&s=${ogScore}` : ""}`}
    <title>The Url Mentalist — is {shareDomain} sus?</title>
    <meta name="description" content={desc} />
    <meta property="og:title" content="The Url Mentalist — is {shareDomain} sus?" />
    <meta property="og:description" content={desc} />
    <meta property="og:type" content="website" />
    <link rel="canonical" href="Live_deployment_link" />
    <meta
      property="og:url"
      content={currentUrl || `Live_deployment_link/?q=${encodeURIComponent(data.queryUrl)}`}
    />
    <meta property="og:image" content={ogImage} />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="The Url Mentalist — is {shareDomain} sus?" />
    <meta name="twitter:description" content={desc} />
    <meta name="twitter:image" content={ogImage} />
  {:else}
    <title>The Url Mentalist — phishing link checker</title>
    <meta
      name="description"
      content="Got a sketchy link? Check it with The Url Mentalist for a free, instant phishing verdict with no signup needed."
    />
    <meta
      name="keywords"
      content="The Url Mentalist, phishing detection, URL scanner, link checker, safe link checker, phishing URL checker, link safety checker"
    />
    <meta property="og:title" content="The Url Mentalist — phishing link checker" />
    <meta
    ...
    <link rel="canonical" href="Live_deployment_link" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="Live_deployment_link" />
    <meta property="og:image" content="Live_deployment_link/urlvet-light.png" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="The Url Mentalist — phishing link checker" />
    <meta
      name="twitter:description"
      content="Sketchy link? Check it with The Url Mentalist. Free, instant, no signup."
    />
  ...
  >
    <header class="relative mb-14 flex flex-col items-center text-center">
      <h1 class="relative text-5xl md:text-6xl font-extrabold tracking-tight z-10">
        ...
        <span class="sr-only">&nbsp;(T-H-E U-R-L M-E-N-T-A-L-I-S-T)</span>
      </h1>

      <p class="relative mt-3 text-gray-500 dark:text-gray-400 text-sm md:text-base z-10">
        Check suspicious links with confidence
      </p>
