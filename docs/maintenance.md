...
Routine operational tasks for keeping a The Url Mentalist deployment healthy.
...
Log files rotate automatically at midnight â€” the logger opens a new file per calendar day. Clean up old files periodically:
